  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const response = await axios.post(
        'http://localhost:8000/api/metric/create-data', // Update this to your API endpoint
        metricData,
        {
          headers: {
      ...
      // Handle success (e.g., show success message or refresh data)
      //console.log('Health metric added:', response.data);
